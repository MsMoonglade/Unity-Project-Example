...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/Cat/Style 4"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		_RampTextureOffset ("Ramp Offset", Range(0,1)) = 0.5
		_RampTextureSize ("Ramp Size", Range(0.001,1)) = 1
		[TCP2Separator]
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float __rampTextureOffset = ( _RampTextureOffset );
				float __rampTextureSize = ( _RampTextureSize );
				...
				half rampOffset = __rampTextureOffset;
				half rampSize = __rampTextureSize * 0.5;
...
/* TCP_DATA u config(unity:"2019.4.0f1";ver:"2.5.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","SPEC_LEGACY","SPECULAR","TEXTURE_RAMP","SPECULAR_TOON_BAND","TEXTURE_RAMP_SLIDERS","SHADOW_COLOR_MAIN_DIR","UNITY_2019_2","UNITY_2019_3","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Outline",RENDER_TYPE="Opaque"];shaderProperties:list[,,,,,,,,sp(name:"Specular Color";imps:list[imp_mp_color(def:RGBA(0.500, 0.500, 0.500, 1.000);hdr:False;cc:3;chan:"RGB";prop:"_SpecularColor";md:"";custom:False;refs:"";guid:"aeeb3d1d-9d3c-4975-9e78-24a7f3169542";op:Multiply;lbl:"Specular Color";gpu_inst:False;locked:False;impl_index:-1),imp_spref(cc:3;chan:"AAA";lsp:"Albedo";guid:"b0fc7a2f-ca88-4462-8835-c419371ab6ae";op:Multiply;lbl:"Specular Color";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False)) */
/* TCP_HASH 3bf27f68e9faaeeb9919e55147effee1 */
