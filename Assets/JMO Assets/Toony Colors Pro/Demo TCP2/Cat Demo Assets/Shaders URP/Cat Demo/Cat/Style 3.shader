...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/Cat/Style 3"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float __stylizedThreshold = ( tex2D(_StylizedThreshold, input.pack0.xy.xy * _StylizedThreshold_ST.xy + _StylizedThreshold_ST.zw).a );
