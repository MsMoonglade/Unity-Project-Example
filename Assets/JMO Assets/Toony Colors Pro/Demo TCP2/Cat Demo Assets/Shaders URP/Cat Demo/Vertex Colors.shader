...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/Vertex Colors"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(unity:"2019.4.0f1";ver:"2.4.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","RIM_LIGHTMASK","SHADOW_COLOR_MAIN_DIR","UNITY_2019_2","UNITY_2019_3","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting",RENDER_TYPE="Opaque"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:True;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_MainTex";md:"";custom:False;refs:"";guid:"dca8a2e3-634b-40b7-94b5-b146dd89038e";op:Multiply;lbl:"Albedo";gpu_inst:False;locked:False;impl_index:-1),imp_vcolors(cc:4;chan:"RGBA";guid:"f38a5cc8-c9c7-4dde-b8c0-0fe780a6f1e4";op:Multiply;lbl:"Albedo";gpu_inst:False;locked:False;impl_index:-1)]),,,,,,,,,,,,,,,,,,,,sp(name:"Emission";imps:list[imp_mp_color(def:RGBA(0.000, 0.000, 0.000, 1.000);hdr:True;cc:3;chan:"RGB";prop:"_Emission";md:"";custom:False;refs:"";guid:"6b24b489-fc96-4a2f-9500-708da35c58d3";op:Multiply;lbl:"Emission Color";gpu_inst:False;locked:False;impl_index:-1),imp_vcolors(cc:3;chan:"AAA";guid:"2eee3837-60fb-4aeb-9237-54e2cb7578aa";op:Multiply;lbl:"Emission";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False)) */
/* TCP_HASH 814957e1d228c2c3d660029c2ffabfe8 */
