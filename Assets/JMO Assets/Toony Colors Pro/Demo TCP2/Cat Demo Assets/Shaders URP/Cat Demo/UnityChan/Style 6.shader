...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/UnityChan/Style 6"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(unity:"2019.4.0f1";ver:"2.4.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","SHADOW_COLOR_MAIN_DIR","CULLING","BACKFACE_LIGHTING_Z","DIFFUSE_TINT","DIFFUSE_TINT_MASK","RAMP_MAIN_OTHER","RAMP_SEPARATED","ALBEDO_HSV","UNITY_2019_2","UNITY_2019_3","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Outline",RENDER_TYPE="Opaque"];shaderProperties:list[,,,,,,,,,,,,,,sp(name:"Diffuse Tint Mask";imps:list[imp_spref(cc:3;chan:"AAA";lsp:"Albedo";guid:"29e57092-bb2d-48dd-9a1f-b40d147631e1";op:Multiply;lbl:"Diffuse Tint Mask";gpu_inst:False;locked:False;impl_index:-1)]),sp(name:"Face Culling";imps:list[imp_enum(value_type:0;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.Culling";guid:"e02995ef-9190-444c-9624-5964ffbeb193";op:Multiply;lbl:"Face Culling";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False)) */
/* TCP_HASH 23652b62bdcfedf20ff617189cb1d359 */
