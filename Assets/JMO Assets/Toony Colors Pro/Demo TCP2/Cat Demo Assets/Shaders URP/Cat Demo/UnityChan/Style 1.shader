...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/UnityChan/Style 1"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(unity:"2019.4.0f1";ver:"2.4.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","RAMP_MAIN_OTHER","RAMP_SEPARATED","SHADOW_COLOR_LERP","RIM","RIM_LIGHTMASK","CULLING","BACKFACE_LIGHTING_Z","DIFFUSE_TINT","DIFFUSE_TINT_MASK","SHADOW_COLOR_MAIN_DIR","UNITY_2019_2","UNITY_2019_3","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting",RENDER_TYPE="Opaque"];shaderProperties:list[,,,,,,,,,sp(name:"Shadow Color";imps:list[imp_mp_color(def:RGBA(0.200, 0.200, 0.200, 1.000);hdr:False;cc:3;chan:"RGB";prop:"_SColor";md:"";custom:False;refs:"";guid:"aab1ad57-f58b-4e03-8bbd-bf184870739e";op:Multiply;lbl:"Shadow Color";gpu_inst:False;locked:False;impl_index:-1),imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_ShadowColor";md:"";custom:False;refs:"";guid:"b20311df-fc66-491b-9fed-6e9efa7dea13";op:Multiply;lbl:"Shadow Color";gpu_inst:False;locked:False;impl_index:-1)]),,,,,,,sp(name:"Diffuse Tint Mask";imps:list[imp_spref(cc:3;chan:"AAA";lsp:"Albedo";guid:"25541bd5-5d28-4726-b59e-d74a1b27d6c2";op:Multiply;lbl:"Diffuse Tint Mask";gpu_inst:False;locked:False;impl_index:-1)]),sp(name:"Face Culling";imps:list[imp_enum(value_type:0;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.Culling";guid:"3bd5a4b4-c672-491c-bfcc-30ec503ac449";op:Multiply;lbl:"Face Culling";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False)) */
/* TCP_HASH bc7df0f3f519a70bf11068c8a4d74bd7 */
