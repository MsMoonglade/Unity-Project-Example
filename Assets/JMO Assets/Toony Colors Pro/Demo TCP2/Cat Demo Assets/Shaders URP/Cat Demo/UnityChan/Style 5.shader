...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/UnityChan/Style 5"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(unity:"2019.4.0f1";ver:"2.4.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","SHADOW_COLOR_MAIN_DIR","CULLING","BACKFACE_LIGHTING_Z","OUTLINE","SHADOW_COLOR_LERP","RIM_OUTLINE","SKETCH","RAMP_MAIN_OTHER","RAMP_SEPARATED","UNITY_2019_2","UNITY_2019_3","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Outline",RENDER_TYPE="Opaque"];shaderProperties:list[,,,,,,,,,sp(name:"Shadow Color";imps:list[imp_mp_color(def:RGBA(0.200, 0.200, 0.200, 1.000);hdr:False;cc:3;chan:"RGB";prop:"_SColor";md:"";custom:False;refs:"";guid:"3b898a9a-9669-42f3-84ef-7486b3544fae";op:Multiply;lbl:"Shadow Color";gpu_inst:False;locked:False;impl_index:-1),imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_ShadowColor";md:"";custom:False;refs:"";guid:"ab545a18-0ee8-4e9d-a6d1-01681393ab18";op:Multiply;lbl:"Shadow Color";gpu_inst:False;locked:False;impl_index:-1)]),,,,,,sp(name:"Sketch Texture";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:True;goff:False;notile:False;triplanar_local:False;def:"black";locked_uv:False;uv:4;cc:3;chan:"AAA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:True;uv_type:ScreenSpace;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_SketchTexture";md:"";custom:False;refs:"";guid:"4bc119b8-c625-40cf-b2ee-1aac116a1caf";op:Multiply;lbl:"Sketch Texture";gpu_inst:False;locked:False;impl_index:-1)]),sp(name:"Sketch Color";imps:list[imp_mp_color(def:RGBA(0.000, 0.000, 0.000, 1.000);hdr:False;cc:3;chan:"RGB";prop:"_SketchColor";md:"";custom:False;refs:"";guid:"35d33d47-15fd-4847-9f27-7bc76f33e73e";op:Multiply;lbl:"Sketch Color";gpu_inst:False;locked:False;impl_index:-1)]),,,,,sp(name:"Face Culling";imps:list[imp_enum(value_type:0;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.Culling";guid:"5803da74-e1d9-4fae-8407-b04392fae76a";op:Multiply;lbl:"Face Culling";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False)) */
/* TCP_HASH e1dbdc7fdd61e80bd2401c9065b0aee4 */
